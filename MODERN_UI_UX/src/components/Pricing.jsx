            ...
            >
              ...
              <div className="text-center mb-6 sm:mb-8 ">
                ...
                <div className="flex items-baseline justify-center ">
                  <span className="text-3xl sm:text-4xl lg:tex-5xl font-bold bg-gradient-to-b from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                    ${plan.price}
                  </span>
                  <span className="text-gray-300 ml-1 sm:ml-2 text-sm sm:text-base ">
                    /month
                  </span>
                </div>
              </div>
